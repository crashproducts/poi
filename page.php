...
<div class="edgtf-container edgtf-default-page-template">
	...
	<div class="edgtf-container-inner clearfix">
        <?php do_action( 'overworld_edge_action_after_container_inner_open' ); ?>
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="edgtf-grid-row <?php echo esc_attr( $edgtf_holder_classes ); ?>">
				<div <?php echo overworld_edge_get_content_sidebar_class(); ?>>
					<?php
						the_content();
						do_action( 'overworld_edge_action_page_after_content' );
					?>
				</div>
		...
		<?php endwhile; endif; ?>
        <?php do_action( 'overworld_edge_action_before_container_inner_close' ); ?>
	</div>
